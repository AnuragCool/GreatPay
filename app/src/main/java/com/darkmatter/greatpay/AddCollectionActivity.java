    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ruser.isEmpty()){
                ...
                }else if(ruser.equals(user.getEmail())){
                    ...
                    Query query=reference.child("Users").orderByChild("username").equalTo(ruser);
                            ...
                            for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                ...
                                if (ruser.equals(username)) {
                                    ...
                                    if(state.equals("found") ){
                                        ...
                                        databaseReference.child("notification").child(uniqueKey).setValue(hashMap2);
