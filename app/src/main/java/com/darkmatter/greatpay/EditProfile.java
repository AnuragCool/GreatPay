...
public class EditProfile extends AppCompatActivity {
    private EditText name,phone,email,address,usernameTv;
    ...
    String nameDb,emailDb,phoneDb,addressDb,image,username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
                ...
                state="not Found";
                                          ...
                                          final String newUsername=usernameTv.getText().toString().trim().toLowerCase();


                                          final DatabaseReference reference= FirebaseDatabase.getInstance().getReference();

                                          Query query=reference.child("Users").orderByChild("username").equalTo(newUsername);
                                                  ...
                                                  for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                                      ...
                                                      if (username.equals(newUsername)) {
                                                          ...
                                                          if (state.equals("found")) {
                                                              usernameTv.setError("Username Exists.Try Another");
